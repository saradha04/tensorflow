...
#include "xla/transforms/collectives/all_gather_broadcast_reorder.h"
#include "xla/transforms/collectives/all_gather_combiner.h"
#include "xla/transforms/collectives/all_reduce_combiner.h"
#include "xla/transforms/collectives/all_reduce_contiguous.h"
#include "xla/transforms/collectives/async_collective_creator.h"
#include "xla/transforms/collectives/collective_quantizer.h"
#include "xla/transforms/collectives/collectives_schedule_linearizer.h"
#include "xla/transforms/convert_memory_placement_to_internal_annotations.h"
#include "xla/transforms/expanders/bitcast_dtypes_expander.h"
#include "xla/transforms/expanders/comparison_expander.h"
#include "xla/transforms/expanders/convolution_4d_expander.h"
#include "xla/transforms/expanders/convolution_pred_expander.h"
#include "xla/transforms/expanders/dot_decomposer.h"
#include "xla/transforms/expanders/dynamic_index_splitter.h"
#include "xla/transforms/expanders/eigh_expander.h"
#include "xla/transforms/expanders/logistic_expander.h"
#include "xla/transforms/expanders/optimization_barrier_expander.h"
#include "xla/transforms/expanders/qr_expander.h"
#include "xla/transforms/expanders/real_imag_expander.h"
#include "xla/transforms/expanders/reduce_decomposer.h"
#include "xla/transforms/expanders/reshape_decomposer.h"
#include "xla/transforms/expanders/rng_bit_generator_expander.h"
#include "xla/transforms/expanders/rng_expander.h"
#include "xla/transforms/expanders/stable_sort_expander.h"
#include "xla/transforms/expanders/stochastic_convert_decomposer.h"
#include "xla/transforms/host_offload_legalize.h"
#include "xla/transforms/host_offloader.h"
#include "xla/transforms/operand_upcaster.h"
#include "xla/transforms/simplifiers/algebraic_simplifier.h"
#include "xla/transforms/simplifiers/all_reduce_folder.h"
#include "xla/transforms/simplifiers/broadcast_canonicalizer.h"
#include "xla/transforms/simplifiers/conditional_canonicalizer.h"
#include "xla/transforms/simplifiers/convert_mover.h"
#include "xla/transforms/simplifiers/dot_merger.h"
#include "xla/transforms/simplifiers/dynamic_dimension_simplifier.h"
...
#include "xla/transforms/simplifiers/hlo_computation_deduplicator.h"
#include "xla/transforms/simplifiers/hlo_constant_folding.h"
#include "xla/transforms/simplifiers/hlo_dce.h"
#include "xla/transforms/simplifiers/hlo_rematerialization.h"
#include "xla/transforms/simplifiers/host_memory_transfer_asyncifier.h"
#include "xla/transforms/simplifiers/optimize_input_output_buffer_alias.h"
#include "xla/transforms/simplifiers/reduce_window_rewriter.h"
#include "xla/transforms/simplifiers/reshape_mover.h"
#include "xla/transforms/simplifiers/result_caster.h"
#include "xla/transforms/simplifiers/simplify_fp_conversions.h"
#include "xla/transforms/simplifiers/slice_sinker.h"
#include "xla/transforms/simplifiers/sort_simplifier.h"
#include "xla/transforms/simplifiers/sub_byte_normalization.h"
#include "xla/transforms/simplifiers/tuple_simplifier.h"
#include "xla/transforms/simplifiers/zero_sized_hlo_elimination.h"
#include "xla/transforms/while_loop_trip_count_annotator.h"
#include "xla/util.h"
